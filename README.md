...
## Ход работы
1. Первоначально создадим директорию проекта и перейдем в нее, а также при помощи команды sudo apt install telnet curl -y установим утилиту для работы с веб-ресурсами через сетевые протоколы:
